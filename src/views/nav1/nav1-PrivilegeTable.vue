	...
	<section>
		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
			<el-form :inline="true" :model="filters">
				...
				<el-form-item>
					<el-button type="primary" v-on:click="getPrivilege">用户名查询</el-button>
				</el-form-item>
				<el-form-item>
					<el-button type="primary" v-on:click="getPrivilege">服务器名查询</el-button>
				</el-form-item>
				<el-form-item>
		...
		<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="servername" label="服务器名" width="120" sortable>
			</el-table-column>
			<el-table-column prop="createdAt" label="创建时间" width="120" :formatter="formatCreateTime" sortable>
			</el-table-column>
			<!--<el-table-column prop="updatedAt" label="创建者" width="120" sortable>-->
			<!--</el-table-column>-->
			...
			<el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
				<el-form-item label="是否运行">
					<el-radio-group v-model="editForm.published">
						...
						<el-radio class="radio" :label="0">不运行</el-radio>
					</el-radio-group>
				</el-form-item>
			</el-form>
			...
			<el-form :model="addForm" label-width="80px" :rules="addFormRules" ref="addForm">
				...
				<el-form-item label="是否运行">
					<el-radio-group v-model="addForm.published">
						<el-radio class="radio" :label="1">运行</el-radio>
						<el-radio class="radio" :label="0">暂停</el-radio>
					</el-radio-group>
				</el-form-item>
			</el-form>
			<div slot="footer" class="dialog-footer">
...
<script>
	...
	import { getServerListPage, getUserListPage, removeUser, batchRemoveUser, editUser, addUser, getPriListPage } from '../../api/api';
